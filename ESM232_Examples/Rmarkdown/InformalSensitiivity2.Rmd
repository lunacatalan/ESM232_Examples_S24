...
results = parms %>% 
  pmap(solarpv,  area=0.1, # allows us to define 2 chaning parameters
       solar=sierraczosolar, clr="green",
       eunit="W", g=FALSE, etype="direct")
...
# The model is not sensitive to ethresh values?

# extract annual 
tmp = map_df(results,`[`, c("annual")) # for each year, get the annual values for each combo of eff and ethresh
